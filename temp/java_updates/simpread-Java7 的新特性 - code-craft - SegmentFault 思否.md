...
本文主要讲 Java7 的新特性，相对于 Java6 而言，Java7 增加了一些重要的特性，比如 NIO2，不像 Java6 那么鸡肋，也算是一个重要的版本。
...
- JSR292 与 InvokeDynamic
- 支持 JDBC4.1 规范
- Path 接口、DirectoryStream、Files、WatchService
- jcmd
- fork/join framework
- Java Mission Control

### 1、suppress 异常 (`新语法`)
>记录finally语句块中产生的异常以及try块中抛出的异常
>不至于finally语句块中的异常覆盖了try块中的异常
...
20967 org.apache.flume.node.Application --no-reload-conf -f /opt/educat/flume_agent/conf/flume.conf -n log_agent" title="" data-original-title="复制"><pre>jcmd -l
15308 org.eclipse.jetty.xml.XmlConfiguration /tmp/start4070493346048555702.properties /opt/educat/apps/conf/jetty8.xml
5624 sun.tools.jcmd.JCmd -l
